...
import ec.edu.uteq.microservicios.msusuarios.client.FacturacionClient;
...
public class EntregaServiceImpl implements EntregaService {
    ...
    public EntregaServiceImpl(EntregaRepository repo, EmailService emailService, FacturacionClient facturacionClient) {
        this.repo = repo;
    ...
    public List<Map<String, Object>> getFacturas() {
        return facturacionClient.getFacturas();
    }
